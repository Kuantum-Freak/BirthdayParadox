...
#define R_MAINICON			"./res/icon.ico" 		// Icon

#define R_PROJNAME		     /* Project Name */ "Birthday Paradox Simulator"
#define R_PRGMNAME		     /* Program Name */ "Birthday Paradox" 
#define R_PVERSION	       /* Version Number */ "4.3.0" 
#define R_COMPANY		          /* Company */ "The Gupta Empire"
#define R_DESCRIPTION	      /* Description */ "Runs a simulation finding the chance of 2 people having the birthday given number of people in a room (size of room)"
